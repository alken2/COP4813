...
{
	if (confirm("Do you wish to return to your shopping cart?")) {
...
{
	if (confirm("Do you wish to checkout from your shopping cart?")) {
...
{
	if (confirm("Do you wish to remove " + title + " from your shopping cart?")) {
